...
def parseBuild():
    ...
    # Stats to display
    displaylist = ["Spec:LifeInc", "AverageDamage", "Life", "Spec:ArmourInc"]

    # Use comprehension to look for the stats we're interested in
    statlist = {playerstat["stat"]:playerstat["value"] for playerstat in allstats if playerstat["stat"] in displaylist}
